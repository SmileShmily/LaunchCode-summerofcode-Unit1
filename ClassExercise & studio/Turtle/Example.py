'''This program doesn’t exercise every single method – that would be tediously long –
but it shows what turtle graphics are like by drawing some simple graphics and then waiting for a keypress before exiting.'''
import sys
import turtle
